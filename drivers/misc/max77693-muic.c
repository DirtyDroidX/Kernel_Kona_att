...
extern void fg_reset_capacity_by_jig_connection_ex(void);
#endif
...
#endif /* CONFIG_MUIC_MAX77693_SUPPORT_CAR_DOCK */
#if defined(CONFIG_MACH_KONA)
		fg_reset_capacity_by_jig_connection_ex();
#endif
		break;
	case CABLE_TYPE_JIG_UART_OFF_MUIC:
...
int max77693_muic_get_mhl_state(void)
{

	if (gInfo->cable_type == CABLE_TYPE_MHL_MUIC ||
		gInfo->cable_type == CABLE_TYPE_MHL_VB_MUIC )		
		return 1;
	else
		return 0;
}
