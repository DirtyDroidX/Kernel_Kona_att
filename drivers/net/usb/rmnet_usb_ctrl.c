...
extern int count_remote_wakeup;
#endif
...
#ifdef CONFIG_HSIC_EURONLY_APPLY
//		printk("count_remote_wakeup value init to 0\n");
...
#ifdef RMNET_CTRL_TX_WORK
static bool rmnet_wait_unblock_request(void)
{
	int spin = 20;
...
re_submit:
	...
	/* wait till, request unblocked */
	if (!rmnet_wait_unblock_request())
		return;
